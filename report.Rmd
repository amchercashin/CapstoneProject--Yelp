...
After all data preparation we have data with `r nrow(restaurants[comp_cases,])` observations (complete cases). We have six generated variables mentioned above. And we have some original variables which were left is data set after all filtering. These variables will be tested on affecting star rating. 
