...
```{r, echo=FALSE, caption = "Table 1: Contingency table among region and restaurant category (cat1)"}
knitr::kable(addmargins(table(region[comp_cases], cat1[comp_cases]), FUN = list(Total = sum), quiet=TRUE))
```
